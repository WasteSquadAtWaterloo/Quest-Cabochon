function initInventory(){
    ...
    items.armor0 = itemFrames.load('armor0'); //game.physics.enable(items.armor0, Phaser.Physics.ARCADE); items.armor0.name = "armor0";
    items.armor1 = itemFrames.load('armor1');// game.physics.enable(items.armor1, Phaser.Physics.ARCADE); items.armor1.name = "armor1";
    items.armor2 = itemFrames.load('armor2'); //game.physics.enable(items.armor2, Phaser.Physics.ARCADE); items.armor2.name = "armor2";
